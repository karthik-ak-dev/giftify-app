    ...
    return (
        <>
            ...
            <div className="fixed right-0 top-0 h-full w-full max-w-md bg-gradient-to-b from-[#2A1260] to-[#1D0F45] shadow-2xl z-50 flex flex-col">
                                ...
                                <div className="flex gap-3">
                                    <div className="flex-[6]">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                required
                                                placeholder="John"
                                                className={`w-full pl-11 pr-3 py-3.5 bg-[#1A0B3F] border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all ${getFieldClass('firstName', formData.firstName)}`}
                                            />
                                        </div>
                                    </div>
                                    <div className="flex-[4]">
                                        ...
                                        <input
                                            ...
                                            required
                                            placeholder="Doe"
                                            className={`w-full px-3 py-3.5 bg-[#1A0B3F] border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all ${getFieldClass('lastName', formData.lastName)}`}
                                        />
                                    </div>
                                </div>
                            </>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-4 py-3.5 bg-[#1A0B3F] border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all ${getFieldClass('email', formData.email)}`}
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="••••••••"
                                    className={`w-full pl-11 pr-11 py-3.5 bg-[#1A0B3F] border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all ${getFieldClass('password', formData.password)}`}
                                />
                                <button
                                    type="button"
                            ...
                            {isSignUp && showPasswordRequirements && (
                                <div className="mt-3 p-3 bg-[#1A0B3F] border border-white/20 rounded-lg">
                ...
                <div className="p-6 border-t border-white/20 bg-[#0F0628]">
